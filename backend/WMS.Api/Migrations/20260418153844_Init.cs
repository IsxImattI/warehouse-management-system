        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovementLogs_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovementLogs_Locations_FromLocationId",
                        column: x => x.FromLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MovementLogs_Locations_ToLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovementLogs_FromLocationId",
                table: "MovementLogs",
                column: "FromLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_MovementLogs_ItemId",
                table: "MovementLogs",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_MovementLogs_ToLocationId",
                table: "MovementLogs",
                column: "ToLocationId");
        }
